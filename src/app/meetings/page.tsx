    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-6 py-12">
        <div className="mb-10 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h1 className="text-3xl font-semibold tracking-tight">Board meetings</h1>
            <p className="mt-2 text-muted-foreground">
              Upload a board meeting recording to generate color-coded minutes
              for your HOA.
            </p>
          </div>
          <Button
        ...
        {isLoading && (
          <p className="text-center text-muted-foreground py-20">Loading meetings…</p>
        )}
        ...
        {!isLoading && !error && meetings?.length === 0 && (
          <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border border-dashed border-border/80 bg-white py-20">
            <p className="mb-8 text-center text-muted-foreground">
              No board meetings yet. Upload your first recording to generate
              minutes.
            </p>
            <Button
              render={<Link href="/meetings/new" />}
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {meeting.file ? ` · ${meeting.file.originalFilename}` : ""}
                      </p>
                    </div>
