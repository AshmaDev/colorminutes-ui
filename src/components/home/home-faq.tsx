...
export function HomeFaq() {
  ...
  return (
    <section id="faq" className={cn(landingSectionClassName, "bg-brand-lilac")}>
      <div className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
        ...
        <div className="space-y-3">
          {faqKeys.map((key) => {
            ...
            return (
              <div key={key} className={landingSurfaceClassName}>
                <button
                  type="button"
                ...
                >
                  ...
                  <ChevronDown
                    className={cn(
                      "mt-1 size-5 shrink-0 text-foreground/60 transition-transform",
                      isOpen && "rotate-180",
                    )}
                    aria-hidden
                  />
